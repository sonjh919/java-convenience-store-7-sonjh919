...
public class StoreControllerTest extends NsTest {
    ...
    private static Stream<Arguments> provideProductsForPrice() {
        return Stream.of(
                ...
                Arguments.of(new String[]{"[오렌지주스-1]", "N", "Y", "N"}, "내실돈1,800"),
                Arguments.of(new String[]{"[오렌지주스-1]", "N", "N", "N"}, "내실돈1,800"),
                Arguments.of(new String[]{"[오렌지주스-1]", "Y", "N", "N"}, "내실돈1,800"),
                Arguments.of(new String[]{"[콜라-5]", "N", "Y", "N"}, "내실돈3,000"),
                ...
                Arguments.of(new String[]{"[사이다-2],[감자칩-1]", "Y", "Y", "Y", "N"}, "내실돈2,500"),
